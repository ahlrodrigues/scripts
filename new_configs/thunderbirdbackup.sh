...
##
#
#Faz cópia incremental do diretório de configurações
#do tunderbird para a pasta /mnt/sda3/Thunderbird
rsync -azhv /home/ahlr/.thunderbird/ /mnt/sda3/Thunderbird/
